...
Se agruparán las variables de interés por país\[^2\]\ nota\ al\ pie\ ,\ por\ lo\ que\ ya\ no\ se\ trabajará\ directamente\ con\ individuos,\ esto\ se\ realizará\ con\ el\ siguiente\ código:\
\[\^2\]:\ nota\ al\ pie?^
